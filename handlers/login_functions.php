...
class UserFunctions {
                        ...
                        if(empty($totp_code))
                          {
                            ...
                            $encrypted = $this->encryptThis($key,$pw);
                            return array(false,"totp"=>true,"error"=>false,"human_error"=>"Please enter the code generated by the authenticator application on your device.","input_password"=>$encrypted);
                          }
  ...
  public function validateUser($userid=null,$hash=null,$secret=null,$detail=false)
  {
     ...
     *
     * @param string $userid ## May be able to get rid of this
  ...
  public function encryptThis($key,$string)
  {
    /*
     * @param string $key
     * @param string $string
  ...
  public function decryptThis($key,$encrypted)
  {
    /*
     * @param string $key
