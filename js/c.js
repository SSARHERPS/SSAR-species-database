  ...
  giveAltVerificationOptions = function() {
    ...
    sms.done(function(result) {
      if (result[0] === true) {
        ...
        return console.warn("Couldn't get a valid result", result, urlString + "?" + args);
      }
    });
