...
(function() {
  var animateLoad, byteCount, checkMatchPassword, checkPasswordLive, delay, doEmailCheck, doTOTPRemove, doTOTPSubmit, evalRequirements, isBlank, isBool, isEmpty, isJson, isNull, isNumber, makeTOTP, mapNewWindows, passwords, root, roundNumber, stopLoad, stopLoadError, toFloat, toInt, toggleNewUserSubmit,
    __slice = [].slice;
