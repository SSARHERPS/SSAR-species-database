...
(function() {
  var animateLoad, byteCount, checkMatchPassword, checkPasswordLive, delay, doEmailCheck, doTOTPRemove, doTOTPSubmit, evalRequirements, isBlank, isBool, isEmpty, isJson, isNull, isNumber, makeTOTP, mapNewWindows, noSubmit, passwords, popupSecret, root, roundNumber, saveTOTP, stopLoad, stopLoadError, toFloat, toInt, toggleNewUserSubmit, totpParams,
    __slice = [].slice;
  ...
  makeTOTP = function() {
    var ajaxLanding, args, hash, key, password, totp, url, urlString, user;
    noSubmit();
    animateLoad();
    user = $("#username").val();
