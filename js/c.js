...
(function() {
  var animateLoad, byteCount, delay, isBlank, isBool, isEmpty, isJson, isNull, isNumber, mapNewWindows, performSearch, root, roundNumber, searchParams, stopLoad, stopLoadError, toFloat, toInt,
    __slice = [].slice;
