...
(function() {
  var animateLoad, byteCount, checkMatchPassword, checkPasswordLive, delay, doEmailCheck, evalRequirements, isBlank, isBool, isEmpty, isJson, isNull, isNumber, mapNewWindows, passwords, root, roundNumber, stopLoad, stopLoadError, toFloat, toInt, toggleNewUserSubmit,
    __slice = [].slice;
